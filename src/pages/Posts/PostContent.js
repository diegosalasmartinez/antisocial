      ...
      <CardContent>
        <Box className='header'>
          ...
          <MyPopover id={idAuthorView} open={openAuthorView} anchorEl={authorView} onClose={this.handleAuthorViewClose}>
            <ProfileInfo username={authReducer.user.username} profile={post.author} isFollowed={isFollowed} onSeeProfile={this.props.onSeeProfile} onFollow={this.props.onFollow} onUnfollow={this.props.onUnfollow}/>
          </MyPopover>
